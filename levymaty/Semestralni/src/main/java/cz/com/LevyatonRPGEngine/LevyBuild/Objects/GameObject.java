...
public abstract class GameObject {
    ...
    public GameObject(String giveName)
    {
        name = giveName;
    }
    
    public GameObject(String giveName, String giveStatus)
    {
        name = giveName;
        status = giveStatus;
    }
    
    public GameObject(String giveName, String giveStatus, String giveSpriteLocation)
    {
        name = giveName;
        status = giveStatus;
